...
export const news = [
  {
    ...
    text:
      "Im Zuge der Vorbereitung auf die kommende Saison nahm der SCS an den diesjährigen Phönix Open teil. Neben den Hauptstädtern kamen auch die Bieber aus Halle nach Leipzig, um für die neue Saison zu testen. Im einem tollen Turnier konnten sich die Berliner gegen Saalebiber Halle, UHC Döbeln, Phönix Leipzig und MFBC Grimma (Damen) durchsetzen und den Turniersieg verbuchen. Zudem stellte der SCS Berlin mit Simon auch den besten Goalie des Turniers. Wir freuen uns über den ersten Erfolg der Saison!",
    image: News2
  },
  {
    title:
  ...
  },
  {
    ...
    text:
      "Endlich ist es wieder soweit. Holt die Trommeln und Trompeten aus dem Schrank - Es ist wieder 2. Bundesliga Zeit in Berlin! Im Ersten Spiel der Saison 19/20 erwartet den SCS Berlin der vorjahres 4. - Floorball Ingolstadt/Nordheim. In der letzten Saison zwei extrem spannende Spiele. Kleine Vorteile für die Berliner: Zum einen haben die Gäste einen weiten Weg hinter sich und zum anderen am Sonntag bereits ein Spiel in den Knochen. Am vortag (21.9) spielen die Gäste aus Ingolstadt bereits in Dessau beim Neuaufsteiger in die 2. Floorball Bundesliga. Wir freuen uns auf jeden der uns beim Saisonauftakt unterstützt. Außerdem ist mit Berliner Pilsner ein neuer Sponsor an Board der gerade für die Fans interessant sein sollte 😍.",
    image: News1
  },
  {
    title: "Erste runde Floorball Deutschland Pokal ✅ ✅",
    text:

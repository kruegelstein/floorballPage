  ...
  render() {
    return (
      <HeaderTextComp>
        ...
        Mannschaft der Aufstieg in die zweite Floorball - Bundesliga, mit dem 7.
        Tabellenplatz in der Saison 2018/19 konnten wir uns in der zweithöchsten Spielklasse in Floorball Deutschland etablieren.
        Der familiäre Verein sucht immer neue talentierte und motivierte Floorballspieler, die ein Teil unseres Teams werden wollen.
      </HeaderTextSection>
      </HeaderTextComp>
    );
  }
